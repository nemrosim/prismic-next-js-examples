...
export type Home_PageConnectionConnection = {
  __typename?: 'Home_pageConnectionConnection';
  /** A list of edges. */
  edges?: Maybe<Array<Maybe<Home_PageConnectionEdge>>>;
...
export type Home_PageConnectionEdge = {
  __typename?: 'Home_pageConnectionEdge';
...
export type QueryAllHome_PagesArgs = {
  ...
  lastPublicationDate_before?: InputMaybe<Scalars['DateTime']>;
  similar?: InputMaybe<Similar>;
  sortBy?: InputMaybe<SortHome_Pagey>;
  tags?: InputMaybe<Array<Scalars['String']>>;
  tags_in?: InputMaybe<Array<Scalars['String']>>;
...
export type WhereHome_Page = {
  /** header */
  header_fulltext?: InputMaybe<Scalars['String']>;
};
